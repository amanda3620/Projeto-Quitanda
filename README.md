...
1. **Clone o Repositório**:
   1. git clone git@github.com:amanda3620/Projeto-Quitanda.git
...
- [Amanda Chiavini]: Autora do projeto
...
---
## Autora 
- [Amanda Chiavini]: Estudante do curso Desenvolvimento de Sistemas
